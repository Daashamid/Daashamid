...
class Hamid:
    ...
    core = ["Python", "HTML", "CSS", "C", "C++"]
    os = ["Linux", "Bash", "Git", "GitHub"]
    net = ["Network+", "TCP/IP", "DNS", "DHCP"]
    obsession = ["Cybersecurity", "Hacking", "IoT"]
    exploring = ["Rust", "Kotlin"]  # vibe-coded, learning
...
- 🔭 Building **Linux automation + Telegram bots in Python**
- 🛡️ Path: **Python → Linux → Network+ → Pentest**
- 🤖 Into bots, automation, system scripting
...
<p align="center">
  <b>Core — I use daily</b><br/>
  <img src="https://skillicons.dev/icons?i=python,html,css,c,cpp,linux,bash,git,github,vscode&theme=dark" />
  <br/><br/>
  <b>Exploring / Vibe-coded — not my main stack</b><br/>
  <img src="https://skillicons.dev/icons?i=rust,kotlin,arduino&theme=dark" />
</p>
...
### 🔒 Private Lab — work in progress

> These are private while I'm finishing them. No links yet — they’ll go public when ready.

| Project | Stack | Status | What it is |
|---|---|---|---|
| `AI-Crypto` | Python | 🚧 WIP | Crypto experiments with AI ideas |
| `Desktop-Remoter` | Python | 🚧 WIP | Remote desktop automation playground |
| `auto-confirm-bot` | Python | 🚧 WIP | Auto-confirm / Telegram bot automation |
| `sms-Bomber` | Python | 🔬 Learning | SMS API playground (rate-limit & API learning, private) |
| `CDE` | Rust (vibe) | 🧪 Exploring | Download Engine experiment |
| `V2DayNg` | Kotlin (vibe) | 🧪 Exploring | Android / client experiment |
